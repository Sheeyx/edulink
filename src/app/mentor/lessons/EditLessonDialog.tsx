      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <input
              className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-primary/80 focus:ring-2 focus:ring-brand-primary/15"
              value={values.title}
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            onClick={onSubmit}
            disabled={loading}
            className="rounded-xl bg-brand-selected px-4 py-2 text-sm font-semibold text-white hover:brightness-90 disabled:opacity-60"
          >
