    ...
    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-[0_8px_24px_rgba(99,99,160,0.08)]">
      ...
      {canSubmit && (
        <button
          ...
          className="mt-4 inline-flex items-center gap-2 rounded-2xl bg-purple-700 px-4 py-2.5 text-sm font-extrabold text-white shadow-sm transition hover:bg-purple-800"
        >
