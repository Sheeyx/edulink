...
export default function DetailsSkeleton() {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white overflow-hidden shadow-[0_10px_35px_rgba(251,133,0,0.08)]">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-[0_10px_35px_rgba(251,133,0,0.08)]">
