    ...
    <nav className="w-full fixed top-0 bg-white shadow z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-3">
          <button className="p-2 border border-transparent rounded hover:bg-gray-100">🛒</button>
          ...
          <button className="p-2 border border-purple-600 text-purple-600 rounded hover:bg-purple-50">🌐</button>
        </div>
